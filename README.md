...
Este projecto implementa la creacion de perfiles de usuario, el envio de mensajes y la moderacion de los mismos. 
Creado rigurosamente bajo la metodologia TDD.
